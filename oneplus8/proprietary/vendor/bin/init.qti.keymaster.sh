...
if [ "$soc_id" -eq 339 ] || [ "$soc_id" -eq 356 ] || [ "$soc_id" -eq 361 ] || [ "$soc_id" -eq 362 ] ||  [ "$soc_id" -eq 367 ] || [ "$soc_id" -eq 405 ] || [ "$soc_id" -eq 415 ] || [ "$soc_id" -eq 439 ] || [ "$soc_id" -eq 456 ] || [ "$soc_id" -eq 501 ] || [ "$soc_id" -eq 502 ]; then
